...
import com.darksidesoftware.jumpingplatformer.GameActivity;
...
public class ResourcesManager {
	...
	private void loadMenuFonts() {
		...
		font = FontFactory.createStrokeFromAsset(activity.getFontManager(), mainFontTexture,
				activity.getAssets(), "font.ttf", 50, true, Color.WHITE, 2, Color.BLACK);
		font.load();
	}
	...
	public void unloadGameTextures() {
		// TODOSince we do not have any game textures as of yet...
	}
	 ...
	 * @param vbom
	 * <br><br>
	 * we use this method at the beginning of game loading, to prepare Resources Manager properly.
